...
strc = load('E:\9.Éî¶ÈÑ§Ï°Ô¤²âÃÚÄòÏµÖ×ÁöÕï¶Ï¼°ÁÆÐ§\ºËÌØÕ÷Ô¤²âÄ£ÐÍ\image-mRNA-prognostic-model-master-kb\imageAndClinicalInfo\imageInfo.mat');
...
for i = 1:nFile
    ...
    %slidePtr = openslide_open(['F:\test\3840xx.svs']);
    mpp = imInfo.mppX(i);
